...
resource "aws_iam_role_policy_attachment" "eks_node_ec2_policy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2FullAccess" # Para gerenciamento do Load Balancer
  role       = aws_iam_role.eks_node_role.name
}
